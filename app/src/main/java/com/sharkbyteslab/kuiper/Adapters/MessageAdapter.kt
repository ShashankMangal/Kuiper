...
import com.sharkbyteslab.kuiper.databinding.ReceiveItemLayoutBinding
import com.sharkbyteslab.kuiper.databinding.SentItemLayoutBinding
...
class MessageAdapter(var context : Context, var list : ArrayList<MessageModel>)  : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder
    {
        return if(viewType == ITEM_SENT)
            ...
            ReceiverViewHolder(LayoutInflater.from(context).inflate(R.layout.receive_item_layout, parent, false))
    }
